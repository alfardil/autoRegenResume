...
% Thanks to Tahmid and Henry for their templates (I got it from them lol).
...
% === Leadership Section ==================================================
\resumeSection{Leadership} \\ [-0.6em]
\textbf{\large Men's Ultimate Frisbee} -- Captain \hfill {\small Sep 2021 -- Present} \\[-1em]
\begin{resumeTinyItemizse}
